var whiteboard = {
    ...
    loadWhiteboard: function (whiteboardContainer, newSettings) {
        ...
        _this.backgroundGrid = $('<div style="position: absolute; left:0px; top:0; opacity: 1; background-image:url(\'' + _this.settings["backgroundGridUrl"] + '\'); height: 100%; width: 100%;"></div>');
